...
prompt2=f'{intro}請基於上述的產品介紹，邀請大家使用此產品，如有連結鼓勵點擊，文末鼓勵按讚留言分享 平台是{socialMedia}，把字數控制在 {socialMedia_dict[socialMedia][0]} 字以內，並在前 {socialMedia_dict[socialMedia][1]} 字有吸引人的標題 受眾是{Audience}，在廣告中{Audience_dict[Audience]} 廣告風格是{style}，以{style_dict[style]}的方式產生出廣告'
